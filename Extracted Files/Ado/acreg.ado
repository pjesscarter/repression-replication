...
*																																*
*									Beta Version, please do not circulate - This Version: June 2019							*    
*																																*
* 									When using this program, please refer to our companion paper								*
*																																*
*  "Inference with Arbitrary Clustering", F. Colella, R. Lalive, S.O. Sakalli, M. Thoenig, 2019, mimeo University of Lausanne	*
*																																*
*********************************************************************************************************************************
*********************************************************************************************************************************
...
*! Beta Version June 2019 (1.0.1)
*! ACREG: Arbitrary Clustering Regression
...
//1) NO CLUSTERING
				...
				di in gr "NO ARBITRARY CLUSTERING CORRECTION"
				if ("`hac'" == ""){
...
di in ye  "may be caused by collinearities or the presence of factor varibles"
					scalar `rkf'		= .
					scalar widstat	= .
				}
				else {
